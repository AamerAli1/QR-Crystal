...
Public Class rpt_report_4
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DynamicCRprinting.rpt_report_4.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_report_4
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_report_4 = New rpt_report_4()
        rpt.Site = Me.Site
        Return rpt
    End Function
